...
urlpatterns = [
    ...
    path('client/<int:pk>/service/<str:service_pk>/<str:port_pk>/<str:operation_pk>',
         api.operation, name='client_operation_detail'),
    path('client/<int:pk>/service/<str:service_pk>/<str:port_pk>/', api.port, name='client_port_detail'),
    path('client/<int:pk>/service/<str:service_pk>/', api.service, name='client_service_detail'),
