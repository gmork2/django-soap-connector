...
urlpatterns = [
    ...
    path('client/<int:client_pk>/',
         require_http_methods(["GET", "DELETE", "OPTIONS"])(api.client), name='client_detail'),
    path('client/', require_http_methods(["GET", "POST", "OPTIONS"])(api.client), name='client_list'),
